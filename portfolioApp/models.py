...
class Flight(models.Model):
    ...
    scriptExteriorModelRotationX = models.CharField(max_length=20, blank=True, null=True, default="0")
    scriptExteriorModelRotationY = models.CharField(max_length=20, blank=True, null=True, default="0")
    ...
    scriptInteriorModelRotationX = models.CharField(max_length=20, blank=True, null=True, default="0")
    scriptInteriorModelRotationY = models.CharField(max_length=20, blank=True, null=True, default="0")
