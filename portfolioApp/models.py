...
# ScriptMapOverlay Model
class ScriptMapOverlay(models.Model):
    min_zoom = models.CharField(max_length=20, blank=True, null=True, default="17")
    max_zoom = models.CharField(max_length=20, blank=True, null=True, default="21")
    zoom = models.CharField(max_length=20, blank=True, null=True, default="17")
    measure_type = models.CharField(max_length=20, blank=True, null=True, default="imperial")
    center_lat = models.FloatField(blank=True, null=True)
    center_lon = models.FloatField(blank=True, null=True)
    bounds_sw_lat = models.FloatField(blank=True, null=True)
    bounds_sw_lon = models.FloatField(blank=True, null=True)
    bounds_ne_lat = models.FloatField(blank=True, null=True)
    bounds_ne_lon = models.FloatField(blank=True, null=True)

    def __str__(self):
        return f"Map Overlay Script {self.id}"
...
class Flight(models.Model):
    ...
    mapoverlay_thumbnail_link = models.CharField(max_length=500, blank=True, null=True, default='https://cdn.balancedrockimaging.com/base/thumbnails/map_overlay.png')
    ...
    exterior_thumbnail_link = models.CharField(max_length=500, blank=True, null=True, default='https://cdn.balancedrockimaging.com/base/thumbnails/ext_model.png')
    interior_link = models.CharField(max_length=500, blank=True, null=True)
    interior_thumbnail_link = models.CharField(max_length=500, blank=True, null=True, default='https://cdn.balancedrockimaging.com/base/thumbnails/int_model.png')
    top_image_link_1 = models.CharField(max_length=500, blank=True, null=True, default='https://cdn.balancedrockimaging.com/base/thumbnails/ext_model.png')
    top_image_link_2 = models.CharField(max_length=500, blank=True, null=True, default='https://cdn.balancedrockimaging.com/base/thumbnails/ext_model.png')
    ...
    script_map_overlay = models.ForeignKey(ScriptMapOverlay, on_delete=models.CASCADE, related_name='flights', blank=True, null=True)
